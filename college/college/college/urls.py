...
from student.views import StudentListCreate, StudentRetrieveUpdateDestroy
from teacher.views import TeacherListCreate, TeacherRetrieveUpdateDestroy
urlpatterns = [
    ...
    path('teachers/<int:pk>/', TeacherRetrieveUpdateDestroy.as_view(), name='teacher-detail'),
